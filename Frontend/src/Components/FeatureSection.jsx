    ...
    <section className="bg-gray-900 py-8 lg:py-12 md:py-10">
      <div className="max-w-7xl mx-auto px-2 sm:px-12 lg:px-16">
        <div className="grid md:grid-cols-4 grid-cols-1 border rounded-2xl  border-white/10 bg-white/5">
          ...
          <div className="flex-1  text-center rounded-3xl shadow-md p-6 border border-gray-300 bg-white/10">
            <div className="flex justify-center items-center mx-auto  text-white rounded-full mb-4">
              <FaShieldAlt className="text-5xl"/>
            </div>
            <h3 className="text-white font-bold text-lg mb-1">Fully Insured</h3>
            <div className="opacity-50"><hr/></div>
            <p className="text-gray-400 text-sm mt-4">
          ...
          <div className="flex-1 text-center  shadow-md p-6 ">
            ...
            <h3 className="text-white font-bold text-lg mb-1">Easy Booking</h3>
            <div className="opacity-50"><hr/></div>
            <p className="text-gray-400 text-sm mt-4">
