    ...
    <div className="space-y-6 px-8 mb-8">
        {services.map((service, index) => (
          ...
          >
            ...
            <Link to='/contact' className="bg-secondary btn1 ease-in-out  lg:text-xl text-lg font-semibold px-8 py-2 hover:px-11 rounded-full shadow-md transition-all duration-500">
              Enquire Now
            </Link>
            </div>
            </div>
